...
if __name__ == "__main__":
    ...
    parser.add_argument("--label", default="GreedyWeightLookahead", type=str, help="Label for the experiment.")
    ...
    # Split the dataset into training (90%) and validation (10%) subsets
    ...
    optimizer = GreedySoftWeightsLookahead(base_optimizer, alpha=0.5, k=10, eval_func=eval_func)
