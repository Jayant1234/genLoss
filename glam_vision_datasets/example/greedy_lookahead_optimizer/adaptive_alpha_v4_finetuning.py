...
if __name__ == "__main__":
    ...
    parser.add_argument("--label", default="AdaptiveLookaheadFinetuneing", type=str, help="Label for the experiment.")
    ...
    for i in range(len(lr)):
        for j in range(len(alpha)):
            ...
            # 1. Retrieve last learning rate from the initial phase and set optimizer to that rate
            last_lr = optimizer.param_groups[0]['lr']  # get the last used LR&#8203;:contentReference[oaicite:3]{index=3}
